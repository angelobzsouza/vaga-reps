				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font">Edição de vaga!</h1>	
						</div>						
					</div>
				</div>
			</div>
			...
			<div class="row text-center">
				<div class="col-md-12">
					<div class="col-md-12 animate-box">
						...
						<form action="<?= base_url('vagas/update') ?>" method="post" name="form_update_vaga" id="form_update_vaga" class="text-left" enctype="multipart/form-data">
								<!-- ID da vaga -->
								<input type="hidden" name="vaga_id" id="vaga_id" value="<?= $vaga->IDVaga ?>">

							<div class="form-row">
								<div class="col-md-6">
									<label for="titulo">Título<span style="color: red;">*</span></label>
									<input type="text" name="titulo" id="titulo" class="form-control" placeholder="Ex: Vaguinha Braba!" maxlength="100" required value="<?= $vaga->TituloVaga ?>">
								</div>

								<div class="col-md-3">
									<label for="valor" id="label_user">Preço R$<span style="color: red;">*</span></label>
									<input type="number" name="valor" id="valor" step="0.01" class="form-control" required value="<?= $vaga->Preco ?>">
								</div>
								...
								<div class="col-md-3">
									...
									<select name="tipo" id="tipo" class="form-control" required>
										...
										<option value="0" <?= $vaga->TipoVaga == 0 ? 'selected':''?>>Indivídual</option>
										<option value="1" <?= $vaga->TipoVaga == 1 ? 'selected':''?>>Compartilhada</option>
										<option value="2" <?= $vaga->TipoVaga == 2 ? 'selected':''?>>Provisória</option>
									</select>
								</div>
							</div><!-- /row -->
							...
							<div class="form-row">
								<div class="col-md-12">
									...
									<textarea name="descricao" id="descricao" class="form-control" rows="5" required placeholder="Escreva um breve parágrafo falando sobre a vaga" maxlength="400" minlength="70"><?= $vaga->DescricaoVaga ?></textarea>
								</div>
							</div>
							...
							<div class="form-row">
								<div class="col-md-12">
									<div class="form-group text-center">
										...
										<a href="<?= base_url('excluir-vaga/'.$vaga->IDVaga) ?>" class="btn btn-primary btn-cadastro">Excluir Vaga</a>
									</div>
								</div>
							</div>
