...
-- Tabela de republicas
CREATE TABLE Republica(
	IDRepublica int unsigned AUTO_INCREMENT PRIMARY KEY,
	NomeRepublica varchar(50),
	Usuario varchar(20),
	Senha varchar(50),
	FotoPerfil varchar(50),
	FotoCapa varchar(50),
	DescricaoRepublica text,
	CEP varchar(9),
	Bairro varchar(100),
	Rua varchar(200),
	Numero varchar(10),
	...
	Telefone varchar(15),
	TipoRepublica varchar(9) DEFAULT 2
);

-- Tabela de vagas
CREATE TABLE Vaga(
	IDVaga int unsigned AUTO_INCREMENT PRIMARY KEY,
	IDRepublica int unsigned,
	Preco float,
	DescricaoVaga text,
	TipoVaga varchar(13),
	SalvoEm date,
...
-- Tabela de fotos da republica
CREATE TABLE FotoRepublica(
	IDFoto int unsigned AUTO_INCREMENT PRIMARY KEY,
	IDRepublica int unsigned,
	Foto varchar(50)
);

-- Tabela de fotos das vagas
CREATE TABLE FotoVaga(
	IDFoto int unsigned AUTO_INCREMENT PRIMARY KEY,
	IDVaga int unsigned,
	Foto varchar(50)
);
...
-- Foreing Keys
ALTER TABLE Vaga 
ADD FOREIGN KEY (IDRepublica) REFERENCES Republica(IDRepublica) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE FotoRepublica 
ADD FOREIGN KEY (IDRepublica) REFERENCES Republica(IDRepublica) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE FotoVaga
ADD FOREIGN KEY (IDVaga) REFERENCES Vaga(IDVaga) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE Cidade
ADD FOREIGN KEY (IDEstado) REFERENCES Estado(IDEstado) ON DELETE CASCADE ON UPDATE CASCADE;
